"""
Django settings for wadiconnect project.
...
SECRET_KEY = 'django-insecure-_nop@sk3zp47$pv$zs_6q)y-y__tg$izdel#%rv5dnze6*4*-h'
...
WSGI_APPLICATION = 'wadiconnect.wsgi.application'
